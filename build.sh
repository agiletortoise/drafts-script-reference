...
echo "Run TypeDoc..."
#npx typedoc --mode file --out "./docs" --name "Drafts Script Reference" src --includeDeclarations --plugin typedoc-theme-fresh --theme fresh --excludeExternals --tsconfig "tsconfig.json"
npx typedoc --plugin typedoc-theme-fresh --theme fresh
